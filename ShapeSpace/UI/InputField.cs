...
namespace ShapeSpace.UI
{
    ...
    {
        public InputField(ref SpriteBatch spriteBatch, Rectangle rect, Color color, Color textColor, SpriteFont font, string text)
        ...
        public void OnClick(Vector2 pos)
        {
            ...
            {
                //Take all of the inputs from the player
            }
        }
    }
}